...
mod tests {
    ...
    fn test_validate_https_url_enterprise_http_server_allowed() {
        let result = validate_https_url("http://106.14.183.34:38080");
        assert!(result.is_ok());
    }

    #[test]
    fn test_validate_https_url_enterprise_http_server_with_trailing_slash_allowed() {
        let client = OAuthClient::with_base_url("http://106.14.183.34:38080/").unwrap();
        assert_eq!(client.base_url(), "http://106.14.183.34:38080");
    }
